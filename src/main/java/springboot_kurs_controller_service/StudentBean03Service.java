...
public class StudentBean03Service {
	...
	List<StudentBean03> listofStudents = List.of(
			...
			new StudentBean03(101L, "Veli Han", "vh@gmail.com", LocalDate.of(1996, 6, 6)),
			new StudentBean03(101L, "Ayse Kan", "ak@gmail.com", LocalDate.of(2008, 1, 1)),
			new StudentBean03(101L, "Mary Star", "ms@gmail.com", LocalDate.of(2008, 5, 5))
			);
	
	
	// Bu metod kullanicidan id alir ve o id yie sahip olan ögrenciyi döndürür
	// id yoksa error verir.
