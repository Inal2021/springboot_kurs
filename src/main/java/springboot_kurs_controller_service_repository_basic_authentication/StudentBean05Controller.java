...
public class StudentBean05Controller {
	...
	@PreAuthorize("hasAuthority('student:write')")
	public StudentBean05 updateFullyById(@Validated @PathVariable Long id, @RequestBody StudentBean05 newStudent) {
	...
	@PreAuthorize("hasAuthority('student:write')")
	public StudentBean05 updatePartiallyById(@Validated @PathVariable Long id, @RequestBody StudentBean05 newStudent) {
	...
	@PreAuthorize("hasAuthority('student:write')")
	public StudentBean05 updatePartiallyById(@Validated @RequestBody StudentBean05 newStudent) throws ClassNotFoundException, SQLException {
